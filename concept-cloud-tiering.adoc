...
https://www.netapp.com/data-services/tiering/tco-calculator/["Use a calculadora de TCO de Cloud Tiering para ver quanto dinheiro você pode economizar"^].
...
As licenças do Cloud Tiering também podem ser compartilhadas com seus clusters que estão armazenando dados em camadas no IBM Cloud Object Storage. A configuração do FabricPool deve ser feita usando o System Manager ou a CLI do ONTAP, mas link:task-licensing-cloud-tiering.html["o licenciamento para esse tipo de configuração é concluído usando Cloud Tiering."]
...
link:task-licensing-cloud-tiering.html["Aprenda a configurar uma assinatura pré-paga"].
...
Após adquirir uma licença do Cloud Tiering, você precisará adicioná-la ao NetApp Console. link:task-licensing-cloud-tiering.html["Veja como usar uma licença BYOL do Cloud Tiering"].
...
NOTE: A partir de agosto de 2021, a antiga licença *FabricPool* foi substituída pela licença *Cloud Tiering*. link:task-licensing-cloud-tiering.html["Saiba mais sobre como a licença Cloud Tiering é diferente da licença FabricPool"].
