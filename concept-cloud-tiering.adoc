...
link:task-licensing-cloud-tiering.html#use-a-cloud-tiering-paygo-subscription["Aprenda a configurar uma assinatura pré-paga"].
...
Depois de comprar uma licença do Cloud Tiering, você precisará adicioná-la ao NetApp Console. link:task-licensing-cloud-tiering.html#use-a-cloud-tiering-byol-license["Veja como usar uma licença BYOL do Cloud Tiering"].
...
NOTE: A partir de agosto de 2021, a antiga licença * FabricPool* foi substituída pela licença * Cloud Tiering *. link:task-licensing-cloud-tiering.html#cloud-tiering-byol-licensing-starting-in-2021["Saiba mais sobre como a licença Cloud Tiering é diferente da licença FabricPool"].
