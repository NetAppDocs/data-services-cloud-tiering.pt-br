...
Para obter uma estimativa, adicione seu cluster ONTAP ao NetApp Console e inspecione-o na página Clusters de camadas de nuvem. Selecione *Calcular economia potencial de níveis* para o cluster iniciar o https://www.netapp.com/data-services/tiering/tco-calculator["Calculadora de TCO de hierarquização de nuvem"^] para ver quanto dinheiro você pode economizar.
...
* link:task-tiering-onprem-aws.html#preparing-your-ontap-clusters["Hierarquização de dados para o Amazon S3"]
